...
Original file is located at
    https://colab.research.google.com/drive/1qTBrprlzQ2cEedsOPPXqB5rB5D2_bKfY
"""
...
state = st.sidebar.selectbox('Qual estado?', estados ) #menú lateral


#SELEÇÃO DA COLUNA
#column ='Casos por 100 mil habitantes'
colunas = ['Novos óbitos','Novos casos','Óbitos por 100 mil habitantes','Casos por 100 mil habitantes']
column = st.sidebar.selectbox('Qual tipo de informação?', colunas ) #menú lateral
...
#fig.show()
st.plotly_chart(fig, use_container_width=True) #mostrar na plataforma
